...
import { isAppendSurfaceEvent, SessionSeq, type Session } from '@deepseek-ai/dsh-session'
...
export function selectMessageDeletion(session: Session, targetSeq: number): MessageDeletionSelection {
  ...
  return { targetSeq: SessionSeq(targetSeq), shadowedSeqs }
}
